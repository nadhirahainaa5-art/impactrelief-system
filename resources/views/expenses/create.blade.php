...
@section('page_title', 'Submit Expense Claim')
...
<div class="claim-hero">
    <div>
        ...
        <p>
            Submit an expense claim only against an approved budget allocation.
            The claim amount must not exceed the remaining approved budget balance.
        </p>
    </div>
    ...
    <div class="claim-layout">
        ...
        <div class="claim-card">
            ...
            <div class="control-rule">
                <strong>Claim rule:</strong><br>
                Staff can only claim expenses from approved budget allocations.
                If the claim exceeds the remaining allocation balance, the system will block the submission.
            </div>
        ...
        <div class="claim-card">
                ...
                <select name="fund_allocation_id" id="allocationSelect" required>
                    ...
                    @foreach($approvedAllocations as $allocation)
                        ...
                        <option value="{{ $allocation->id }}"
                                ...
                                {{ old('fund_allocation_id') == $allocation->id ? 'selected' : '' }}>
            ...
            <div class="premium-field">
                ...
                <textarea name="description"
                          rows="4"
                          placeholder="Explain what this claim is for...">{{ old('description') }}</textarea>
            </div>

            <div class="submit-panel">
                <div>
                    <h3>Submit for admin review?</h3>
                    <p>The claim will be pending until approved by administrator.</p>
                </div>
